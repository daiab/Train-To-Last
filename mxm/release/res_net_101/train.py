import mxm.release.res_net_101.read_data as data
import mxm.release.res_net_101.res_net as net
import mxnet as mx

import mxm.release.res_net_101.config as cfg
from mxm.release.res_net_101 import fit
from mxm.release.res_net_101 import predict
