import mxm.release.res_net_x.read_data as data
import mxm.release.res_net_x.res_net as net
import mxnet as mx

import mxm.release.res_net_x.config as cfg
from mxm.release.res_net_x import fit
from mxm.release.res_net_x import predict
