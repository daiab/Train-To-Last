from tfm.release.googlenet.frame.base_net import BaseNet
...
class Net(BaseNet):
    def def_model(self):
        ...
        (self.feed('inception_3a_1x1',
         ...
         .concat(axis=3, name='inception_3a_output')
        ...
        (self.feed('inception_3b_1x1',
         ...
         .concat(axis=3, name='inception_3b_output')
        ...
        (self.feed('inception_4a_1x1',
         ...
         .concat(axis=3, name='inception_4a_output')
        ...
        (self.feed('inception_4b_1x1',
         ...
         .concat(axis=3, name='inception_4b_output')
        ...
        (self.feed('inception_4c_1x1',
         ...
         .concat(axis=3, name='inception_4c_output')
        ...
        (self.feed('inception_4d_1x1',
         ...
         .concat(axis=3, name='inception_4d_output')
        ...
        (self.feed('inception_4e_1x1',
         ...
         .concat(axis=3, name='inception_4e_output')
        ...
        (self.feed('inception_5a_1x1',
         ...
         .concat(axis=3, name='inception_5a_output')
        ...
        (self.feed('inception_5b_1x1',
         ...
         .concat(axis=3, name='inception_5b_output')
         .avg_pool(7, 7, 1, 1, padding='VALID', name='pool5_7x7_s1')
         .reshape(flatten=True, name="reshape")
         .wx_b([None, cfg.class_num], [cfg.class_num], relu=False, bn=False,  name="fc_1")
         )

        (self.feed("fc_1", "labels")
         .cross_entropy(name="cross_entropy")
         .loss_plus_norm(weight_decay=cfg.weight_decay, name="loss_plus_norm"))
