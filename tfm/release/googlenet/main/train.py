...
from tfm.release.googlenet.frame.__init__ import *
from tfm.release.googlenet.frame.read_data import read_and_decode

import tfm.release.googlenet.main.config as cfg
from tfm.release.googlenet.main.net import Net
